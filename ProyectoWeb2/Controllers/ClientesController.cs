...
namespace ProyectoWeb2.Controllers
{
    public class ClientesController : Controller
    {
        ...
        public ClientesController(ConexionContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("id,Nombre,cedula_Juridica,pagina_Web,direccion_Fisica,telefono,sector")] Clientes clientes)
        {
